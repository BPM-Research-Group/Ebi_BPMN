use crate::{
    ...
    traits::{
        ...
        transitionable::{
            ...
            transition_2_consumed_tokens_xor_join, transition_2_produced_tokens_message,
        },
    },
};
...
impl Transitionable for BPMNMessageEndEvent {
    ...
    fn transition_2_consumed_tokens<'a>(
        ...
        Ok(task_consumed_tokens!(self, transition_index, parent))
    }
    ...
    fn transition_2_produced_tokens(
        ...
        Ok(transition_2_produced_tokens_message!(self, bpmn))
    }
}
